...
public class cardView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            //json 받아오기 시작
            String result = task.execute("getBookList",getIntent().getExtras().getString("id"),"0").get();//flag:getBookList를 사용하여
//            Log.d("ggb ",result);
            ...
            mAdapter = new CustomAdapter( mArrayList,getApplicationContext(),hm);
